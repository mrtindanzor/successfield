...
function NotLoggedIn(){
  return (
    <div 
      ...
      <Link 
        to='/users/join' 
        className="hidden md:flex gap-2 whitespace-nowrap items-center text-lg sm:text-xl font-bold text-white px-4 py-2 rounded bg-green-400 border-2 hover:border-gray-300 hover:translate-y-1 transition-transform duration-300 ease-linear">
        <FileText />
        Apply
      </Link>
    </div>
